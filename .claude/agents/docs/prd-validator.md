...
- 인증: JWT(Access Token, 24h) + OAuth2(Google/Kakao)
...
3. **OAuth2 provider(Google/Kakao) 사양을 추측하지 마라**
...
5. OAuth2 provider 문서 — Google/Kakao 등록·스코프·콜백
